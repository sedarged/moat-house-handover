...
VALUES ($headerId, $dept, $planned, $used, $variance, $reason, $at, $user)";
    ...
    public BudgetSummaryPayload LoadBudgetSummary(long sessionId) => LoadBudget(sessionId, "system").Summary;
